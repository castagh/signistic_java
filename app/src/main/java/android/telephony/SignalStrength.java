 ...
 */
public final class SignalStrength extends SignalStrength implements Parcelable {
     ...
     */
    /** @hide */
    public SignalStrength(int rssi, int rsrp, int rsrq, int rssnr, int cqiTableIndex,
    ...
    private int inRangeOrUnavailable(int rsrp, int i, int i1) {
        return 0;
    }
     ...
     */
    /** @hide */
    public SignalStrength(int rssi, int rsrp, int rsrq, int rssnr, int cqi,
                                 int timingAdvance) {
        this(rssi, rsrp, rsrq, rssnr, CellInfo.UNAVAILABLE, cqi, timingAdvance);
    }

    /** @hide */
    public SignalStrength(android.hardware.radio.V1_0.LteSignalStrength lte) {
    ...
    /** @hide */
    public SignalStrength(android.hardware.radio.V1_6.LteSignalStrength lte) {
        // Convert from HAL values as part of construction.
    ...
    public SignalStrength copy() {
        return new SignalStrength(this);
    }
    ...
    private static final SignalStrength sInvalid = new SignalStrength();
     ...
     */
    private SignalStrength(Parcel in) {
        mRssi = in.readInt();
        mSignalStrength = mRssi;
        mRsrp = in.readInt();
        mRsrq = in.readInt();
        ...
        mLevel = in.readInt();
        if (DBG) log("SignalStrength(Parcel): " + toString());
    }
